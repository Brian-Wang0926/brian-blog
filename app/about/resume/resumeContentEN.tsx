...
export default function ResumeContentEN() {
  return (
    <>
      {/* 個人資訊與聯絡方式 */}
      <div className="mb-6">
        <article className="space-y-4">
          <div>
            <div className="space-y-1 ms:flex gap-x-4 items-center">
              <h1 className="text-3xl font-bold">{siteConfig.author}</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-x-10 gap-y-6">
            <div className="sm:col-span-2 [hyphens:auto] order-last sm:order-first">
              Full-stack engineer with experience developing and maintaining
              responsive websites. Proficient in modern front-end frameworks and
              back-end technologies. Passionate about creating immersive user
              experiences and developing high performance applications.
            </div>
            {/* 聯絡方式 */}
